...
export default function EditTemplatePage() {
  useSetPageTitle("Редактировать шаблон")
  ...
  const { data: template, isLoading } = $api.useQuery("get", "/api/templates/{template_id}", {
  ...
  const updateMutation = $api.useMutation("put", "/api/templates/{template_id}", {
    onSuccess: () => router.push("/templates"),
    onError: () => alert("Ошибка при обновлении шаблона"),
  })
